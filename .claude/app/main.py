...
def _load_runtime_artifacts() -> None:
    ...
    app.state.treatment_dict = load_json(_resolve_artifact_path("treatment_dict.json"))
    with open(_resolve_artifact_path("doctor_profile.json"), encoding="utf-8") as fh:
